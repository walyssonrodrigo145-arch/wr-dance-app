...
- ⏭️ Próximas etapas: **1.2 SEO público** → **2.1 Indique e Ganhe** → **2.4** cobrança boleto/link → **3.1** Meu Perfil professor → **3.2** LoadingScreen → **3.3** contratos em blocos → **3.4** fatura avulsa/simulador → **3.5** Diário de ensaio.
